...
const AddBlog = () => {
  ...
  return (
    ...
    onSubmit={onSubmitHandler}>
      <div className='bg-white w-full max-w-3x1 p-4 md:p-10 sm:m-10 shadow rounded'></div>
...
<p className='mt-4'>Sub Title</p>
      ...
      <p className='mt-4'>Blog Decscription</p>
      <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
       ...
       <select
        onChange={e => setCategory(e.target.value)} name="category" className='mt-2 px-3 py-2 border text-gray-500 
       ...
       <div>
        <div className='flex gap-2 mt-4'><p>Publish Now</p>
